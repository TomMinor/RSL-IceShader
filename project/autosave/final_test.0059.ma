...
//Name: final_test.0059.ma
//Last modified: Sun, May 10, 2015 02:30:30 am
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.38242456999246532 14.122739109189979 35.54614769464402 ;
	setAttr ".r" -type "double3" -15.938352729648605 -359.39999999978971 2.4849445959823341e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.591867479062273;
...
createNode transform -n "nurbsSphere1";
	...
	setAttr ".r" -type "double3" 90.011884652754233 11.111064433068686 -0.47755424490985166 ;
...
createNode RenderManDisplacement -n "RenderManDisplacement1";
	...
	setAttr -k on ".rman__riattr__trace_displacements" 1;
	setAttr -k on ".cornerRoundness" 1;

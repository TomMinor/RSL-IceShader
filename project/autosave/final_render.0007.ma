...
//Name: final_render.0007.ma
//Last modified: Mon, May 11, 2015 12:43:22 am
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 121.99324088791288 106.69469926095577 28.037855750250195 ;
	setAttr ".r" -type "double3" -37.199999999982523 81.999999999998025 0 ;
	setAttr ".rpt" -type "double3" -2.4695853293639173e-16 3.1635757710411505e-15 1.6259721247225088e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 155.46437449090811;
...
createNode transform -n "nurbsSphere1";
	setAttr ".t" -type "double3" -1.139259314057034e-18 5.6276752377446417 1.951563910473908e-18 ;
...
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".coi" 43.977712482268245;
	setAttr ".ow" 30;
	setAttr ".imn" -type "string" "camera1";
	setAttr ".den" -type "string" "camera1_depth";
	setAttr ".man" -type "string" "camera1_mask";
createNode transform -n "camera1_aim" -p "camera1_group";
	setAttr ".t" -type "double3" 0 3.8562532684628641 0 ;
	setAttr ".drp" yes;
...
createNode RenderMan -s -n "renderManGlobals";
	...
	setAttr -k on ".rman__riattr__trace_samplemotion" 1;
	setAttr ".rman__riattr__dice_referencecamera" -type "string" "worldcamera";
	setAttr -k on ".rman__riattr___ShadingRate" 50;
	setAttr -k on ".rman__riattr__trace_autobias" 1;
...
createNode animCurveTL -n "camera1_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0 53 -39.789794433000154 98 4.4578284658621925 135 40.76779889620213;
	setAttr -s 4 ".kit[0:3]"  18 9 9 18;
	setAttr -s 4 ".kot[0:3]"  18 9 9 18;
createNode animCurveTL -n "camera1_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 20.298216354700045 53 20.298216354700045 98 20.29821635470033 135 20.298216354700074;
	setAttr -s 4 ".kit[0:3]"  18 9 9 18;
	setAttr -s 4 ".kot[0:3]"  18 9 9 18;
createNode animCurveTL -n "camera1_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 50.124102485130358 53 -2.7502512300508641 98 -39.649999572238919 135 1.2990836011148374;
	setAttr -s 4 ".kit[0:3]"  18 9 9 18;
	setAttr -s 4 ".kot[0:3]"  18 9 9 18;
createNode animCurveTU -n "camera1_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 1 53 1 98 1 135 1;

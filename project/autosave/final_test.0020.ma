...
//Name: final_test.0020.ma
//Last modified: Fri, May 08, 2015 08:24:08 pm
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.1961792962462243 14.504300472038965 39.913143280711978 ;
	setAttr ".r" -type "double3" -12.938352729647701 -362.19999999982088 4.9732824146393249e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 40.715221822922224;
...
createNode RenderManShader -n "RenderManShader_Ice";
	addAttr -ci true -k true -sn "frostAmount" -ln "frostAmount" -dv 0.5 -smn 0 -smx 
		1 -at "float";
	...
	addAttr -ci true -k true -sn "refractionMix" -ln "refractionMix" -dv 1 -smn 0 -smx 
		1 -at "float";
	addAttr -ci true -k true -sn "reflectionMix" -ln "reflectionMix" -dv 1 -smn 0 -smx 
		1 -at "float";
	addAttr -ci true -uac -k true -sn "colourTint" -ln "colourTint" -at "float3" -nc 
		3;
	addAttr -ci true -k true -sn "colourTintr" -ln "colourTintR" -dv 0.7839999794960022 -at "float" 
		-p "colourTint";
	addAttr -ci true -k true -sn "colourTintg" -ln "colourTintG" -dv 0.90979999303817749 -at "float" 
		-p "colourTint";
	addAttr -ci true -k true -sn "colourTintb" -ln "colourTintB" -dv 0.89410001039505005 -at "float" 
		-p "colourTint";
	addAttr -ci true -k true -sn "frostEnvMap" -ln "frostEnvMap" -dt "string";
	setAttr ".sn" -type "string" "shaders/icecube.slo";
	setAttr ".si" -type "string" "float frostAmount -default {0.5}\nfloat Kr -default {0.5}\nfloat Kt -default {0.5}\nfloat shinyness -default {50}\nfloat ior -default {1.3}\nfloat refractionMix -default {1}\nfloat reflectionMix -default {1}\ncolor colourTint -default {0.784  0.9098  0.8941}\nstring frostEnvMap -default {}\n";
	setAttr -k on ".ior" 1.1000000238418579;
	setAttr -k on ".colourTint" -type "float3" 0.85358006 0.91000003 0.90295875 ;
	setAttr -k on ".frostEnvMap" -type "string" "";
...
createNode partition -n "mtorPartition";
	...
	setAttr ".sd" -type "string" "#\n# generated by slim for tom at Fri May 08 19:55:08 BST 2015\n#\nslim 2 TOR slim {\n}\n";

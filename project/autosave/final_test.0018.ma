...
//Name: final_test.0018.ma
//Last modified: Fri, May 08, 2015 08:03:38 pm
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.5162070381150938 14.324690481982456 29.848449126508967 ;
	setAttr ".r" -type "double3" -14.738352729647456 -370.59999999982495 2.0223575005553182e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.591867479064931;
...
createNode mesh -n "polySurfaceShape15" -p "polySurface14";
	...
	setAttr ".iog[0].og[1].gcl" -type "componentList" 2 "f[2]" "f[4]";
...
createNode RenderManShader -n "RenderManShader_Ice";
	...
	addAttr -ci true -k true -sn "shinyness" -ln "shinyness" -dv 50 -smn 0 -smx 100 
		-at "float";
	addAttr -ci true -k true -sn "ior" -ln "ior" -dv 1.2999999523162842 -smn 0 -smx 1 -at "float";
	...
	setAttr -k on ".ior" 0.80000001192092896;

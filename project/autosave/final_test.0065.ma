...
//Name: final_test.0065.ma
//Last modified: Sun, May 10, 2015 06:44:48 am
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.5060568986308103 10.827801555091636 29.844449542769603 ;
	setAttr ".r" -type "double3" -14.738352729654958 -356.99999999978377 -1.4929310170089479e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.884021270923895;
...
createNode RenderManShaderObject -n "RenderManShaderObject1";
	addAttr -ci true -k true -sn "texfreq" -ln "texfreq" -dv 1 -smn 0 -smx 1 -at "float";
	addAttr -ci true -k true -sn "DMult" -ln "DMult" -smn 0 -smx 1 -at "float";
	addAttr -ci true -k true -sn "cornerRoundness" -ln "cornerRoundness" -dv 0.5 -smn 
		0 -smx 1 -at "float";

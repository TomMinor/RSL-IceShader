...
//Name: final_test.0076.ma
//Last modified: Sun, May 10, 2015 09:12:34 am
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.2698692586322891 9.3243154583223529 29.468991097197438 ;
	setAttr ".r" -type "double3" -6.3383527296550213 -362.19999999978126 -4.9732824146391924e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.88402127092392;
...
createNode RenderManShaderObject -n "RenderManShaderObject1";
	...
	addAttr -ci true -k true -sn "cornerRoundness" -ln "cornerRoundness" -dv 0.5 -smn 
		0 -smx 1 -at "float";
	addAttr -ci true -k true -sn "displacementAmount" -ln "displacementAmount" -dv 0.10000000149011612 
	...
	setAttr -k on ".displacementAmount" 1;

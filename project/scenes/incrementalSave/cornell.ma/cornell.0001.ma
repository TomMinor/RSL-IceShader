...
//Name: cornell.ma
//Last modified: Fri, May 01, 2015 12:57:52 pm
//Codeset: UTF-8
requires maya "2014";
...
fileInfo "osv" "Linux 3.18.7-200.fc21.x86_64 #1 SMP Wed Feb 11 21:53:17 UTC 2015 x86_64";
...
createNode mesh -n "polySurfaceShape14" -p "polySurface13";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".pt";
	setAttr ".pt[0]" -type "float3" 0 0 9.1423197 ;
	setAttr ".pt[1]" -type "float3" 0 0 9.1423197 ;
	setAttr ".pt[4]" -type "float3" 0 0 9.1423197 ;
	setAttr ".pt[7]" -type "float3" 0 0 9.1423197 ;
	setAttr ".pt[8]" -type "float3" 0 0 9.1423197 ;
	setAttr ".pt[11]" -type "float3" 0 0 9.1423197 ;
	setAttr ".bck" 3;
...
createNode RenderManShader -n "RenderManShader_Ice";
	...
	addAttr -ci true -k true -sn "shinyness" -ln "shinyness" -dv 50 -smn 0 -smx 100 
		-at "float";
	setAttr ".sn" -type "string" "iceProject/shaders/ice.slo";
	setAttr ".si" -type "string" "float Kr -default {1}\nfloat Kt -default {1}\nfloat ior -default {1.5}\nfloat Ks -default {1}\nfloat shinyness -default {50}\n";
	setAttr -k on ".ior" 0.97500002384185791;
	setAttr -k on ".shinyness" 33.557048797607422;

...
//Name: final_render.ma
//Last modified: Sun, May 10, 2015 10:11:22 pm
//Codeset: UTF-8
requires maya "2014";
...
createNode RenderMan -s -n "rmanFinalOutputGlobals0";
	...
	setAttr -k on ".rman__riopt__Display_filterwidth" -type "float2" 0 0 ;
...
createNode RenderMan -s -n "renderManGlobals";
	...
	setAttr -k on ".rman__riopt___PixelSamples" -type "float2" 2 2 ;
	setAttr -k on ".rman__riopt___VolumePixelSamples" -type "float2" 2 2 ;
	...
	setAttr ".rman__riattr__displacementbound_coordinatesystem" -type "string" "shader";
	setAttr -k on ".rman__riattr__displacementbound_sphere" 0;
	setAttr -k on ".rman__riattr__volume_depthrelativeshadingrate" 2;
